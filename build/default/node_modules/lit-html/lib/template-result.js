...
function convertConstantTemplateStringToTrustedHTML(value) {
  ...
  if (trustedTypes && !policy) {
    policy = trustedTypes.createPolicy('lit-html', {
      createHTML: s => s
    });
  }
...
export class TemplateResult {
  ...
  getTemplateElement() {
    const template = document.createElement('template'); // this is secure because `this.strings` is a TemplateStringsArray.
    // TODO: validate this when
    // https://github.com/tc39/proposal-array-is-template-object is implemented.

    template.innerHTML = convertConstantTemplateStringToTrustedHTML(this.getHTML());
    return template;
  }
